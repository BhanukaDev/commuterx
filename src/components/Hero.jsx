...
export const Hero = () => {
  return (
    <div className="flex h-screen w-full flex-col px-5 pt-16 sm:px-[6%]">
      ...
      <p className=" mt-5 w-full text-lg text-zinc-500 sm:mt-4 sm:text-xl md:mt-8 md:text-2xl">
      ...
      <figure className="right-10 flex h-[calc(100%-64px)] w-1/3 max-w-[280px] items-center md:absolute lg:right-14">
